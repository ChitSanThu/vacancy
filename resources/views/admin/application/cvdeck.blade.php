                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-around">
                                                        ...
                                                        <a href="{{route('applications.change_status',['applicant'=>$application->id,'status'=>config('vacancy.application.screening')])}}" class="btn btn-sm btn-primary mx-3" data-toggle="tooltip" data-placement="top" title="To Screening">Accept</a>

                                                        <a href="{{route('applications.change_status',['applicant'=>$application->id,'status'=>config('vacancy.application.reject')])}}" class="btn btn-sm btn-danger ">Reject</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
