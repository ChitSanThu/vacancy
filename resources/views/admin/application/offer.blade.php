        ...
        <div class="row">
            <div class="col-12">
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        @if (session('requiredEmployeeState'))
                            <div class="row">
                                <div class="col-12">
                                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                                        {!!session('requiredEmployeeState')!!}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-around">
                                                        ...
                                                        <a href="{{ route('applications.change_status', ['applicant' => $application->id, 'status' => config('vacancy.application.hire')]) }}"
                                                            class="btn btn-sm btn-primary mx-3" disabled>Hire</a>
                                                        @endif
