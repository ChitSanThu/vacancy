                                    ...
                                    <tbody>
                                        @foreach ($applications as $index => $application)
                                            <tr>
                                                ...
                                                <td class="text-center">{!! $application->interview_date !!}</td>
                                                <td>
                                                    <div class="d-flex justify-content-around">
                                                        <button class="btn btn-sm btn-success" data-toggle="modal"
                                                            data-target="#cvDetail" data-id="{{ $application->id }}"><i
                                                                class="fas fa-eye"></i></button>
                                                        <a href="{{route('applications.change_status',['applicant'=>$application->id,'status'=>config('vacancy.application.shortlisted')])}}" class="btn btn-sm btn-primary mx-3">Shortlisted</a>
