                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-around">
                                                        ...
                                                        <a href="{{route('applications.change_status',['applicant'=>$application->id,'status'=>config('vacancy.application.offer')])}}" class="btn btn-sm btn-primary mx-3">Job Offer</a>
